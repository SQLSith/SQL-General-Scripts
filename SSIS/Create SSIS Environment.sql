...
/***************** Update data here *******************/
	...
	insert	@Variables values ('Connection', 'MyDatabase', N'String', N'Data Source=DESKTOP-09BT47P\SQL2017;Initial Catalog=BulltechAudit;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;', 0, null)
