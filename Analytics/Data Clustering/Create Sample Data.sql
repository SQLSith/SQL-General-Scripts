/*
		...
		Description:
		This script creates test data for use with Data Clustering Demos. 
		The intention is to create a set of X,Y data points in the range of 0 to 100 on each access. 
